...
interface FirstSowingInterface extends ethers.utils.Interface {
  functions: {
  ...
  events: {
    ...
    "TokenURIUpdated(uint256,string)": EventFragment;
...
export type TokenURIUpdatedEvent = TypedEvent<
  [BigNumber, string] & { id: BigNumber; tokenURI: string }
>;
...
export class FirstSowing extends BaseContract {
  ...
  interface: FirstSowingInterface;
